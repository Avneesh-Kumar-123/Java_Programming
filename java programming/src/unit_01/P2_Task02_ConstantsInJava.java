...
public class P2_Task02_ConstantsInJava {
	...
	//only static values can be used inside static functions so classes are used to create non static functions and variable so that:
	//non static values can also be called inside main
	//
...
class NewClass{
	...
	System.out.println(a+b);
	//value of pi is taken from class P2_Task02_ConstantsInJava into the new class created
